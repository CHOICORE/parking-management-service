...
/**
 * This code is identical to the NanoId implementation found in
 *
 * [NanoId](https://github.com/viascom/nanoid-kotlin/blob/main/src/main/kotlin/io/viascom/nanoid/NanoId.kt)
 *
...
internal object NanoId {
     ...
     */
    @JvmStatic
    fun calculateMask(@NotNull alphabet: String) =
